from HW_16.utils import User, Executor, Customer
...
def create_user(user: dict):
    ...
    user_new_dict = {"id": user_new.id, "first_name": user_new.first_name, "last_name": user_new.last_name,
...
def get_user(user):
    ...
    """
    res_dict = {"id": user.id, "first_name": user.first_name, "last_name": user.last_name, "age": user.age,
